...
driver.find_element_by_css_selector("#tel").send_keys("16606154672@163.com")
driver.find_element_by_css_selector("#email").send_keys("166061546272")
...
driver.find_element_by_css_selector("#passwordB").send_keys("1234")
driver.find_element_by_css_selector("#telB").send_keys("16606154672@163.com")
driver.find_element_by_css_selector("#emailB").send_keys("166061546272")
